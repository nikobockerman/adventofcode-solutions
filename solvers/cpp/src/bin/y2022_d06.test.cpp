...
TEST_F(T2022Day6, p1Example1) {
  ...
  verifyResult<uint64_t>(solver::p1(example1Input), exampleResult);
}

TEST_F(T2022Day6, p1Example2) {
  constexpr auto exampleResult = 5;
  verifyResult<uint64_t>(solver::p1(example2Input), exampleResult);
}

TEST_F(T2022Day6, p1Example3) {
  constexpr auto exampleResult = 6;
  verifyResult<uint64_t>(solver::p1(example3Input), exampleResult);
}

TEST_F(T2022Day6, p1Example4) {
  constexpr auto exampleResult = 10;
  verifyResult<uint64_t>(solver::p1(example4Input), exampleResult);
}

TEST_F(T2022Day6, p1Example5) {
  constexpr auto exampleResult = 11;
  verifyResult<uint64_t>(solver::p1(example5Input), exampleResult);
}

TEST_F(T2022Day6, p2Example1) {
  constexpr auto exampleResult = 19;
  verifyResult<uint64_t>(solver::p2(example1Input), exampleResult);
}

TEST_F(T2022Day6, p2Example2) {
  constexpr auto exampleResult = 23;
  verifyResult<uint64_t>(solver::p2(example2Input), exampleResult);
}

TEST_F(T2022Day6, p2Example3) {
  constexpr auto exampleResult = 23;
  verifyResult<uint64_t>(solver::p2(example3Input), exampleResult);
}

TEST_F(T2022Day6, p2Example4) {
  constexpr auto exampleResult = 29;
  verifyResult<uint64_t>(solver::p2(example4Input), exampleResult);
}

TEST_F(T2022Day6, p2Example5) {
  constexpr auto exampleResult = 26;
  verifyResult<uint64_t>(solver::p2(example5Input), exampleResult);
}
